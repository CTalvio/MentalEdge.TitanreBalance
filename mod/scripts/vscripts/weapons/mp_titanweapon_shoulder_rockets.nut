...
void function Init_titanweapon_shoulder_rockets( entity weapon )
{
	...
	{
		float missileSpeed = IsMultiplayer() ? VANGUARD_SHOULDER_MISSILE_SPEED + 300 : SHOULDERROCKETS_MISSILE_SPEED
		SmartAmmo_SetMissileSpeed( weapon, missileSpeed )
		float homingSpeed = IsMultiplayer() ? ( (VANGUARD_SHOULDER_MISSILE_SPEED + 300) / SHOULDERROCKETS_MISSILE_SPEED * 250 ) : 250.0
