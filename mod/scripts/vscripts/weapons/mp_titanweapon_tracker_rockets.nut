...
table <entity, bool> warningSound
...
function MissileThink( weapon, missile )
{
	...
	#if SERVER
// 		thread MissileWarning( weapon, missile )
...
// function MissileWarning( weapon, missile )
// {
// 	expect entity( missile )
// 	#if SERVER
// 		missile.EndSignal( "OnDestroy" )
//
// 		entity missileTarget = missile.GetMissileTarget()
// 		warningSound[missileTarget] <- false
//
// 		while ( IsValid( missile ) )
// 		{
// 			if ( IsValid( missileTarget ) && missileTarget.IsPlayer() )
// 			{
// 				float distance = Distance( missile.GetOrigin(), missileTarget.GetOrigin() )
//
// 				if ( distance < 1536 && warningSound[missileTarget] == false )
// 				{
// 					EmitSoundOnEntityOnlyToPlayer( missileTarget, missileTarget, "titan_cockpit_missile_close_warning" )
// 					warningSound[missileTarget] = true
// 				}
// 			}
// 			WaitFrame()
// 		}
